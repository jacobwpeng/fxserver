        ...
        namespace bus
        {
            ...
            int ProcessBusManager::Init(const std::string& conf_path)
            {
                ...
                try
                {
                    ...
                    //    std::unique_ptr<ProcessBus> pb(ProcessBus::CreateFrom(
            ...
            {
                ProcessBusPtr pb = FindBus(bus_id);
                if (pb == NULL) return -1;
            ...
            ProcessBusManager::ProcessBusPtr ProcessBusManager::FindBus(unsigned bus_id)
            {
